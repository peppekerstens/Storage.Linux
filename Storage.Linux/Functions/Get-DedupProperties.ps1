...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-DedupProperties', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-DedupProperties
