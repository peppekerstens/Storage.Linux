...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Disable-PhysicalDiskIdentification', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Disable-PhysicalDiskIdentification
