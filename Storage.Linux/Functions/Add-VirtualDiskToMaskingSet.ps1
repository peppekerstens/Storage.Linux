...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Add-VirtualDiskToMaskingSet', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Add-VirtualDiskToMaskingSet
