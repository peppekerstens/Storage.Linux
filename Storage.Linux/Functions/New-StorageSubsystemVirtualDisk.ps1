...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-StorageSubsystemVirtualDisk', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName New-StorageSubsystemVirtualDisk
