...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Enable-PhysicalDiskIdentification', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Enable-PhysicalDiskIdentification
