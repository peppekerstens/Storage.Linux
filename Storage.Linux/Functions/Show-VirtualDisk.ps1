...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Show-VirtualDisk', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Show-VirtualDisk
