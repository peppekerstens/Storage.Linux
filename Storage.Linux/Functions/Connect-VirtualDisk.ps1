...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Connect-VirtualDisk', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Connect-VirtualDisk
