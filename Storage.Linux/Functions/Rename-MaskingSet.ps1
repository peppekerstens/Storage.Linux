...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Rename-MaskingSet', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Rename-MaskingSet
