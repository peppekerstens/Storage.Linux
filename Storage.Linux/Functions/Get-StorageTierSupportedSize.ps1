...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-StorageTierSupportedSize', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-StorageTierSupportedSize
