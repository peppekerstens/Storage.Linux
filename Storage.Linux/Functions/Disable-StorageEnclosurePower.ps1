...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Disable-StorageEnclosurePower', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Disable-StorageEnclosurePower
