...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Remove-VirtualDisk', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Remove-VirtualDisk
