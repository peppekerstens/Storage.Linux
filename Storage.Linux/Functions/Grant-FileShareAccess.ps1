...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Grant-FileShareAccess', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Grant-FileShareAccess
