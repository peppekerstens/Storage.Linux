...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Repair-VirtualDisk', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Repair-VirtualDisk
