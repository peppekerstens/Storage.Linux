...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Remove-StorageFileServer', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Remove-StorageFileServer
