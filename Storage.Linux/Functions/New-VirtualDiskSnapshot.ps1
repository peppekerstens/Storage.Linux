...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-VirtualDiskSnapshot', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName New-VirtualDiskSnapshot
