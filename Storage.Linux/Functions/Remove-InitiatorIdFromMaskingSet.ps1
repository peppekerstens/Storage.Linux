...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Remove-InitiatorIdFromMaskingSet', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Remove-InitiatorIdFromMaskingSet
