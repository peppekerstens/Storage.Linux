...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Remove-MaskingSet', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Remove-MaskingSet
