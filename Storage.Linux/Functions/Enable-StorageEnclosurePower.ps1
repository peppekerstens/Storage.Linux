...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Enable-StorageEnclosurePower', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Enable-StorageEnclosurePower
