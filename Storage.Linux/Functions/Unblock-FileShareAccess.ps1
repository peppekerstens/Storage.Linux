...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Unblock-FileShareAccess', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Unblock-FileShareAccess
