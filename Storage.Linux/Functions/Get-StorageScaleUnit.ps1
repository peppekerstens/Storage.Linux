...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-StorageScaleUnit', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-StorageScaleUnit
