...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Resize-VirtualDisk', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Resize-VirtualDisk
