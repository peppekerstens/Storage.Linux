...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Start-StorageDiagnosticLog', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Start-StorageDiagnosticLog
