...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Block-FileShareAccess', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Block-FileShareAccess
