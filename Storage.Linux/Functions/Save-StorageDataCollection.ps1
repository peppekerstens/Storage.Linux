...
param(
    ...
    [ValidateNotNullOrEmpty()]
    [Save-StorageDataCollection.StorageDataCollectionType]
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Save-StorageDataCollection', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Save-StorageDataCollection
