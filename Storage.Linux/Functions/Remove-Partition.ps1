...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Remove-Partition', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Remove-Partition
