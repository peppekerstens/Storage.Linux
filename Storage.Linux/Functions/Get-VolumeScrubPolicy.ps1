...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-VolumeScrubPolicy', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-VolumeScrubPolicy
