...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Add-PartitionAccessPath', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Add-PartitionAccessPath
