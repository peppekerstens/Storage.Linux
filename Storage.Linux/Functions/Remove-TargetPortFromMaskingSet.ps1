...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Remove-TargetPortFromMaskingSet', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Remove-TargetPortFromMaskingSet
