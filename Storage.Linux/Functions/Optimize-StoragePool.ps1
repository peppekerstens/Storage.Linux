...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Optimize-StoragePool', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Optimize-StoragePool
