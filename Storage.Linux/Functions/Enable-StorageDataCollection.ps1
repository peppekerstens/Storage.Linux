...
param(
    ...
    [ValidateNotNullOrEmpty()]
    [Enable-StorageDataCollection.StorageDataCollectionType]
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Enable-StorageDataCollection', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Enable-StorageDataCollection
