...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-StorageSite', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-StorageSite
