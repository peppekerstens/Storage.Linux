...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Update-StoragePool', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Update-StoragePool
