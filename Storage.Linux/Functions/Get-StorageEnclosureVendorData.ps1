...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-StorageEnclosureVendorData', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-StorageEnclosureVendorData
