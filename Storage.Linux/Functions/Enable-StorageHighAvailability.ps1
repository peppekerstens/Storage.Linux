...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Enable-StorageHighAvailability', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Enable-StorageHighAvailability
