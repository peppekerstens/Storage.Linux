...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Get-FileShareAccessControlEntry', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Get-FileShareAccessControlEntry
