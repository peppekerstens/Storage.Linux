...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('Stop-StorageJob', [System.Management.Automation.CommandTypes]::Function)
...
.ForwardHelpTargetName Stop-StorageJob
